...
class PHNSDE(nn.Module):
    """
        ...
        - f(t, y(t), u(t)) is the drift (R^n), here we set f to the port-Hamiltonian dynamics
    ...
    def __init__(self, scale, net_cfg, dtype, device):
        ...
        self.dH = MLP(self.in_dim, 1, hidden_dim, 1, activation=nn.ReLU()).to(self.device)
